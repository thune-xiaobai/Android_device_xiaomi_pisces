...
class NvCSJPEGCapTest(NvCSTestBase):
    ...
    def setupGraph(self):
        ...
        self.fdelay = self.options.fdelay
        self.obGraph.setStillParams(self.width, self.height)

    def runTest(self, args):
        print "capturing jpeg image..."

        if(self.options.imager_id == 0):
            self.obCamera.setAttr(nvcamera.attr_continuousautofocus, 1)
